...
_map('n', 'öq', '<cmd>try | cprev | catch | clast | catch | endtry<CR>', { desc = 'Go to previous quickfix item' })
_map('n', 'äq', '<cmd>try | cnext | catch | cfirst | catch | endtry<CR>', { desc = 'Go to next quickfix item' })
_map('n', 'öd', function()
